...
> **Підказка.** Якщо відкрити `main.exe` подвійним кліком (без консольного вікна), ви побачите невелике повідомлення з прикладами команд. Воно підкаже, як саме запускати інструмент із потрібними аргументами.
